package com.common.schedule.annotation.impl;
...
import com.common.schedule.annotation.Scheduled;
import com.common.schedule.scheduler.ScheduledTask;
import com.common.schedule.scheduler.Scheduler;
import com.common.schedule.scheduler.impl.CronTrigger;
	...
	public Object postProcessAfterInitialization(final Object bean, String beanName) {
		ReflectionUtils.doWithMethods(AopUtils.getTargetClass(bean), new MethodCallback() {
			public void doWith(Method method) throws IllegalArgumentException,
				...
				if (annotation == null || !annotation.defaultStart()) {
					return;
				}
